...
_Public status last changed: 2026-06-29 03:43 KST_
...
| raw Ollama / gemma4 | raw OSS | `███████░░░` 72 <sub>n=5, medium</sub> | `██████░░░░` 64 <sub>n=5, medium</sub> | `███████░░░` 72 <sub>n=5, medium</sub> |
...
- The raw Ollama / gemma4 row is a direct Ollama baseline without Hermes localworker/profile-adapter context, shown on the same scale for side-by-side comparison.
